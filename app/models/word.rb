class Word < ActiveRecord::Base
  attr_accessible :name, :word_language_id,  :wrong_words_attributes,:correct_usages_attributes, :wrong_usages_attributes, :word_translations_attributes, :notes_attributes
  belongs_to :user
  ...
  accepts_nested_attributes_for :notes, :reject_if => lambda { |a| a[:notes].blank? }
