class Word < ActiveRecord::Base
  attr_accessible :name, :word_language_id, :correct_words_attributes, :wrong_words_attributes,:correct_usages_attributes, :wrong_usages_attributes, :word_translations_attributes
  belongs_to :user
